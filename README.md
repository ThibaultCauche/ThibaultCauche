...
**Front & mobile** : React, Next.js, Flutter, TypeScript, Tailwind CSS
**Back-end** : .NET, Node.js, Express, Nest.js
...
- 💻 **[Portfolio](https://github.com/ThibaultCauche/portfolio)** Site web, Next.js / TypeScript / Tailwind / Framer Motion
- 🏋️ **[GymTimer](https://github.com/ThibaultCauche/GymTimer)** Suivi de séances de musculation avec chronomètre en tâche de fond

## Me contacter

🔗 [thibaultcauche.com](https://www.thibaultcauche.com) · [LinkedIn](https://www.linkedin.com/in/thibault-cauche-aa2983180/)
